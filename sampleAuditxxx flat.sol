...
// File: contracts/filter/IOperatorFilter_MKII.sol
...
// File: contracts/xxx_shared_props.sol


pragma solidity ^0.8.0;

contract xxxDelegate
{
    address public _delegate0 = 0x0000000000000000000000000000000000000000; //null address for sample
}
...
// File: contracts/openzeppelin-contracts/contracts/utils/Counters.sol
...
// File: contracts/filter/ERC721OperatorFilter_MKIII.sol
...
abstract contract ERC721OperatorFilterV2 is ERC721URIStorage, Ownable, xxxDelegate
{
    //address public _delegate = 0x0000000000000000000000000000000000000000; //null for sample

    modifier delegateOnly() virtual
    {
        require(msg.sender == _delegate0, 'Only Delegated wallet is allowed to mint');
        _;
    }
...
// File: contracts/721_Tradeup_MKVII.sol
...
contract xxxTU is ERC721URIStorage, Ownable, ReentrancyGuard, IERC2981, ContextMixin, RoyaltiesV2, xxxDelegate, ERC721OperatorFilterV2
{
    using Strings for *;
    ...
    string constant collectionName = "xxxTU";
    string constant collectionNameUriEncoded = "xxxTU";
    string constant collectionSymbol = "TU";
    string private baseURI = ""; // null address for sample

    address private royaltyReceiver =  0x0000000000000000000000000000000000000000; // null address for sample
    ...
    {
        _mintLoop(_address, _numTokens, _tokenType, uid);
    }

    function _mintLoop(address _receiver, uint8 _numTokens, uint256 _tokenType, string[] calldata uid) internal
    {
    ...
    function isApprovedForAll(address _owner, address _operator) public override view returns (bool isOperator)
    {
        ...
        //if (_operator == address(// null address for sample))
        //{
        //    return true;
        //}
